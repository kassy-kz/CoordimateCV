...
package orz.kassy.CoordimateCV;
...
//            InputStream is = getResources().getAssets().open("orig.jpg");
            InputStream is = getResources().getAssets().open("orig2.png");
...
//        mImageView3.setImageBitmap(bmpBlack);
        ...
        Utils.matToBitmap(matBlack, bmpContour);
//        mImageView4.setImageBitmap(bmpContour);
        ...
        Utils.matToBitmap(matBlack, bmpContour2);
//        mImageView5.setImageBitmap(bmpContour2);

        // 反転（黒を抜き出す場合のみ）
        Core.bitwise_not(matBlack, matBlack);
        ...
        Utils.matToBitmap(matObject, bmpObject);
        mImageView2.setImageBitmap(bmpObject);
...
//        mImageView2.setImageBitmap(bmpCut);
    }
}
